...
int main(const int argc, const char **argv) {
    ...
    IplImage *pImage = NULL, *pSmallImage = NULL, *pHistEq = NULL;
    const char *test = argv[1];
    const char *window_name_1 = "Original";
    const char *window_name_2 = "Resized";
    const char *window_name_3 = "Histogram Equlization";
    const int width = 250;
    ...
    cvShowImage(window_name_3, pHistEq);
